...
| [hypnotherapist-session](./hypnotherapist-session/) | Therapeutic interaction style that provides calming, patient guidance with positive reinforcement | **Hook:** SessionStart - Creates a judgment-free environment with supportive language, manageable steps, and anxiety reduction |
